...
<head>
  ...
  <body onload="window.print();"  >   
    <div>
      <p align="center" style="font-size: 12pt"> <u>PT DHARMA JASA ANUGERAH</u><br>JOURNAL VOUCHER </p>
    </div>
      ...
      <table class="no_border" width="100%">
        <tr class="td_no-border">
          ...
          <td class="td_no-border" colspan="3"> <?php foreach ($header as $h) {echo $h->receive_from;} ?></td>
