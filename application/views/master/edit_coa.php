                            ...
                            <div class="portlet light ">
                                <div class="portlet-body">
                                    <ul class="nav nav-tabs">
                                        ...
                                        <a href="<?php echo site_url('/master/coa/view_coa#tab_1_3') ?>"
                                           class="pull-right">
                                            <button class="btn red"><i class="fa fa-chevron-circle-left"> Cancel</i>
                                            </button>
                                        </a>
                                    </ul>
                                                    ...
                                                    <div class="tab-pane fade active in" id="tab_1_1"><br>
                                                        <?php foreach ($editCoa as $ec) { ?>
                                                            <form role="form" method="POST"
                                                                  action="<?php echo site_url() . '/master/coa/save_edit_coa' ?>">
                                                                <input type="hidden" name="id" class="form-control"
                                                                       value="<?php echo $ec->id ?>">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-icon">
                                                                        ...
                                                                        <input type="text" name="debit" id="total"
                                                                               pattern="[0-9]*"
                                                                               class="form-control input text-right"
                                                                               value="<?php echo $ec->debit ?>">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-icon">
                                                                        <i class="fa fa-dollar font-green"></i>
                                                                        <input type="text" name="credit" id="total"
                                                                               pattern="[0-9]*"
                                                                               class="form-control input text-right"
                                                                               value="<?php echo $ec->credit ?>">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
