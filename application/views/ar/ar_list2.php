                ...
                <table id="example" class="table table-striped table-bordered" cellspacing="0">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php $d=New DateTime($al->date); echo $d->format('d-m-Y') ?></td>
                          <td><?php echo $al->description ?></td>
                          <td><?php echo $al->receive_from ?></td>
                          <td align="center">
                            ...
                            <?php }else{ ?>
                              <div class="input-group input-group-sm">
                                ...
                                <span class="input-group-btn ">
                                    <button class="btn grey enabled" nov="<?php echo $al->no_voucher ?>" type="button"><i id="<?php echo $al->no_voucher ?>" class=" fa fa-pencil"></i></button>
                                </span>
                              </div>
                            <?php } ?>
                           ...
                           <div class="btn-group">
                            <button class="btn red blue-hoki-stripe btn-xs dropdown-toggle" data-toggle="dropdown"><i class="angle-down"></i> Action
                              ...
                              <ul class="dropdown-menu">
                                ...
                                <li>
                                  ...
                                  <?php
                                    ...
                                    if ($al->total >= 50000000 ) {
                                      $result .= '<a href ="'.site_url('/ar/ar/print_ar_up?id=').$al->no_voucher.'" target="_blank"  "><i class="fa fa-print"></i> Print
                                        </a>';
                                    }else{
                                       $result .= '<a href ="'.site_url('/ar/ar/print_ar?id=').$al->no_voucher.'" target="_blank"  "><i class="fa fa-print"></i> Print
                                        </a>';
                                    }
                                    echo $result;
                                  ?>
                                ...
                                <?php
                                  $result = '<li>';  
                                  if ($al->status == "posted" OR $al->Fclose == "close" OR $al->Fmonth == 'close') {
                                    echo '
                                      <li>
                                      </li>
                                    ';
                                ...
                                <!-- <li>
                                  <a href="<?php echo site_url().'/approve/approve/get_trx?id='.$al->no_voucher ?>" target="_blank"><i class="fa fa-recycle"></i> Status </a>
                                </li> -->
                              </ul>
                          </div>
                          </td>
