...
class M_coa extends CI_Model{
	...
	public function get_coa(){
		$data = $this->db->query("select * from coa ORDER BY coa_id ASC");
		return $data->result();
	}
	...
	public function save_edit_coa($id, $coa_id,$name_coa,$date,$subgroup,$debit,$credit,$header,$active){
		$data = $this->db->query(" update coa set name_coa = '".$name_coa."' , date = '".$date."' , subgroup = '".$subgroup."' , debit = '".$debit."' , credit = '".$credit."' , header = '".$header."' ,active = '".$active."', coa_id = '".$coa_id."' WHERE id = '".$id."' ");
	}
